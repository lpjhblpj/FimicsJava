//: com.mic.demo.containers/Lists.java
package com.mic.demo.containers; /* Added by Eclipse.py */
// Things you can do with Lists.

import com.mic.demo.mindview.util.Countries;
...
public class Lists {
    ...
    public static void basicTest(List<String> a) {
        ...
        // Lists allow random com.mic.demo.access, which is cheap
        // for ArrayList, expensive for LinkedList:
        s = a.get(1); // Get (typed) com.mic.demo.object at location 1
        i = a.indexOf("1"); // Tell index of com.mic.demo.object
        ...
        a.remove("3"); // Remove this com.mic.demo.object
