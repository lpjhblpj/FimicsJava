//: com.mic.demo.net/mindview/atunit/AtUnitRemover.java
// Displays @Unit com.mic.demo.annotations in compiled class files. If
// first argument is "-r", @Unit com.mic.demo.annotations are removed.
// {Args: ..}
...
import com.mic.demo.mindview.util.BinaryFile;
import com.mic.demo.mindview.util.ProcessFiles;
        ...
        try {
            ...
            for (CtMethod method : ctClass.getDeclaredMethods()) {
                ...
                for (Annotation ann : attr.getAnnotations()) {
                    if (ann.getTypeName()
                            .startsWith("com.mic.demo.mindview.atunit")) {
